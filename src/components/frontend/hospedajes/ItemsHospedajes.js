                    ...
                    <MDBRow>
                        ...
                        <MDBCol lg="6">
                            ...
                            <p style={{color: '#07737f', borderTop: '1px solid #ccc', paddingTop: 4, marginTop : '5%'}}>
                                {item.max_huespedes > 1 ? item.max_huespedes + ' huéspedes' : item.max_huespedes + ' huésped'} · {item.habitaciones > 1 ? item.habitaciones + ' habitaciones' : item.habitaciones + ' habitación'}<br />{item.camas > 1 ? item.camas + ' camas': item.camas + ' cama'} · {item.wc > 1 ? item.wc + ' baños': item.wc + ' baño'}
                            </p>
                            <p>
