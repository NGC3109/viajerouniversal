...
//   const dataDestiny = props.data
//   const idUser = props.uid
//   return(
...
class DetailActividades extends Component {
  ...
  async componentDidMount(){
    let idActividad = this.props.match.params.idActividad
                            ...
                            <div>
                              ...
                              />
                                <Button
                                  ...
                                  style={{marginTop: '1%'}}
                                  onClick={() => this.createNewCommentItem('actividades', this.props.match.params.idActividad)}
                                >
                                  Comentar
                                </Button>
                              </div>
