...
import ItemsDestinosWebMobile from './ItemsDestinosWebMobile'
...
class DestinosWebMobile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      dataDestiny: [],
        ...
        : 
          <div>
            ...
            {this.state.dataDestiny.length !== 0 ?
              ...
              >
                <ItemsDestinosWebMobile data={this.state.dataDestiny}/>
              </InfiniteScroll>
            :
              <MDBContainer>
...
export default DestinosWebMobile;